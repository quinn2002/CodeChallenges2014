...
namespace CodeChallenge09_PalindromeCheck
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                Console.WriteLine("\nEnter text to check if it's a palindrome (a string containing only numbers will check its binary format):");
                userInput = Console.ReadLine();
                Console.WriteLine("{0}", Convert.ToBoolean(isPalindrome(userInput)));
