...
namespace CodeChallenge02_RomanNumerals
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                Console.WriteLine("Enter a Roman Numeral to get its numerical value (type 'q' to quit):");
                userInput = Console.ReadLine();
                if (AreValidRomanNumerals(userInput))
                {
                    Console.WriteLine("Value is: {0}\n\n", RomanNumeralsToDecimal(userInput));
                }
                else
                {
                    Console.WriteLine("Invalid Roman Numerals.  Please try again.\n\n");
                }
            } while (userInput != "q");
        }
        ...
        private static List<int> getRomanNumeralDecimalLookupVals(string userInput)
        {
